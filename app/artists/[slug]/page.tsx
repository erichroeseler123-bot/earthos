      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
        <div className="space-y-10">
          ...
          <div className="bg-zinc-900/60 border border-zinc-800 p-2 rounded-3xl overflow-hidden min-h-[380px]">
            ...
            {intel?.spotifyId && (
              <iframe src={`https://open.spotify.com/embed/artist/${intel.spotifyId}?utm_source=generator&theme=0`} width="100%" height="380" frameBorder="0" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" className="rounded-2xl" />
            )}
          </div>
        </div>
